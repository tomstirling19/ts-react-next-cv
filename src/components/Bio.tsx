...
const Bio = () => {
  return (
    <BioContainer className='page-container'>
      <LeftCol>
        <BioTitle className='header-text bio-title'>Welcome.</BioTitle>
        <BioText className='primary-text bio-text'>
          <p>
      ...
      <RightCol>
        <BioTitle className='header-text bio-title'>Links.</BioTitle>
        <LinksContainer>
          <a
